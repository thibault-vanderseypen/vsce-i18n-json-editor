...
export class IJEDataRenderUtil {
  ...
  static renderTable(translations: IJEDataTranslation[], languages: string[], page: IJEPage, sort: IJESort, showFolder: boolean = true) {
  ...
  static renderList(translations: IJEDataTranslation[], selectTranslation: IJEDataTranslation, languages: string[], page: IJEPage, sort: IJESort, showFolder: boolean = true){
    let render = '<div class="container-fluid">';
    render += '<div class="row">';
    ...
    if (selectTranslation) {
      ...
      render += `
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-10">
                            <input id="input-key-${selectTranslation.id}" class="form-control ${selectTranslation.valid ? "" : "is-invalid"}" type="text" placeholder="Key..." value="${
        selectTranslation.key
      }" onchange="updateInput(this,${selectTranslation.id});" />
